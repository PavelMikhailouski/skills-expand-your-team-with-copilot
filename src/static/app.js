document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderActivityCard(name, details) {
    ...
    activityCard.innerHTML = `
      ...
      <div class="share-section">
        ...
        <button class="share-button share-twitter" data-activity="${name}" title="Share on X (Twitter)">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.747l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
        </button>
    ...
    // Build share text for this activity
    const shareText = `Check out "${name}" at Mergington High School! ${details.description} Schedule: ${formattedSchedule}. Learn more at ${window.location.href}`;
    ...
    activityCard.querySelector(".share-copy").addEventListener("click", (e) => {
      ...
      navigator.clipboard.writeText(shareText).then(() => {
        ...
        btn.title = "Could not copy – please copy manually";
        setTimeout(() => {
          btn.title = "Copy link";
        }, 2000);
      });
